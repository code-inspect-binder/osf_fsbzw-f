...
#-------------------------------------------------
#
# Model of Stone_et_al (2021) Experiment-1 MATCH condition
...
p.ballon  = list(type="syn-obj", ctime=0, npres=1, name="ballon", cat="DP", gend="masc", col="gelb", animacy="inani", ref="pic")
p.blume   = list(type="syn-obj", ctime=0, npres=1, name="blume", cat="DP", gend="fem", col="gelb", animacy="inani", ref="pic")
